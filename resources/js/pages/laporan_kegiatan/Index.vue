...
const pagination = props.laporan;
const kegiatan = pagination.data;
                ...
                <Table>
                    ...
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead>Deksripsi Keigatan</TableHead>
                    ...
                    <TableBody>
                        <TableRow v-for="(keterangan, index) in kegiatan" :key="index">
                            ...
                            <!-- <TableCell>{{ keterangan.judul_kegiatan }}</TableCell> -->
                            <TableCell>
                                <div class="whitespace-pre-line">
                                    {{ keterangan.deskripsi_kegiatan }}
                                </div>
                            </TableCell>
                            <TableCell> {{ keterangan.hasil }} </TableCell>
                            <TableCell> {{ keterangan.waktu }} </TableCell>
                            <TableCell>
                                <a
                                    v-if="kegiatan.dokumentasi"
                                    :href="route('laporan-kegiatan.dokumentasi', kegiatan.dokumentasi.split('/').pop())"
                                    target="_blank"
                                    rel="noopener"
                                    class="underline"
                                    >Lihat dokumentasi</a
                            ...
                            <TableCell>
                                <div class="flex flex-row gap-2">
                                    ...
                                    <Badge variant="secondary"> Hapus </Badge>
                                </div>
                            </TableCell>
                        </TableRow>
                    </TableBody>
