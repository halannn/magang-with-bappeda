...
return new class extends Migration
{
    ...
    {
        Schema::create('profile_magang', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('bidang_magang', ['PIPP', 'KRA', 'P3', 'Litbang', 'Seketariat'])->nullable();
    ...
    {
        Schema::dropIfExists('profile_magang');
    }
};
